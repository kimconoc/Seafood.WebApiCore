...
const LayoutAuthentication = (props) => {
    ...
    return (
        <div className="relative w-full min-h-screen p-10 bg-lite dark:bg-darkbg isolate">
         <img className="absolute bottom-0 left-0 right-0 z-[-1]" src="/bg.png" alt="bg"></img>
         ...
         <h1 className="text-text1 text-center font-bold text-lg mb-1 lg:text-xl lg:mb-3">{heading}</h1>
         {children}
         </div>
        </div>
    );
